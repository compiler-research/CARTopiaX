...
constexpr real_t kDiffusionCoefficientImmunostimulatoryFactor =
    1000;  // 1000 micrometers^2/minute
/// Decay constant of immunostimulatory factor in min⁻¹
constexpr real_t kDecayConstantImmunostimulatoryFactor =
    0.016;  // 0.016 minutes^-1
...
constexpr real_t kOxygenReferenceLevel =
    38.;  // Reference level of oxygen at the boundaries of the simulation space
          // in mmHg
/// Initial oxygen concentration in each voxel in mmHg
constexpr real_t kInitialOxygenLevel =
    38.0;  // Initial voxel concentration of oxygen in mmHg
/// Oxygen saturation in the microenvironment in mmHg
constexpr real_t kOxygenSaturation =
    30.0;  // 30.0 // Oxygen saturation in mmHg in microenvironment
/// Forces
